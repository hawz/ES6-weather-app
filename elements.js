// Here we fetch the HTML elements that we need in order to export them to the app.js
...
export const ELEMENT_WEATHER_TEMP = ELEMENT_WEATHER_BOX.lastElementChild;
